         ...
         $(function () {
            ...
            function fadeInOut() {
                $('.slideImg').eq(n % 5).fadeOut(1300);
                $('.indicator li').eq(n % 5).find('a').delay(3000).css({
                    'background-color':'#F7B500'
                });
                n++;
                $('.slideImg').eq(n % 5).fadeIn(1000);
                $('.indicator li').eq(n % 5).find('a').delay(3000).css({
                    'background-color':'#3E3832'
                });
            }
            ...
            $('.left').click(function(){
                clearInterval(timer);
                $('.slideImg').eq(n % 5).fadeOut();
                $('.indicator li').eq(n % 5).find('a').delay(3000).css({
                    'background-color':'#F7B500'
                });
                n--;
                $('.slideImg').eq(n % 5).fadeIn();
                $('.indicator li').eq(n % 5).find('a').delay(3000).css({
                    'background-color':'#3E3832'
                });
                timer=setInterval(fadeInOut, 3000);
        ...
        $(function(){
            ...
            function contgallery(){
                $('.cont2gallery div').eq(n%3).animate({'left':-400},'linear');
                $('.cont2gallery div').eq(m%3).css('left','400px').animate({'left':0},'linear');
                n++;
                m++;
            }
        })
        ...
        $(function(){
            ...
            $('.contBottom .bottomBox .box2 .box_2').eq(0).find('.caption').addClass('on');
            ...
            $('.contBottom .bottomBox .box2 .box21').mouseover(function(){
                $('.contBottom .bottomBox .box2 .box21 .caption').stop().css({'opacity':'1'})
            })
            $('.contBottom .bottomBox .box2 .box22, .contBottom .bottomBox .box2 .box23').mouseover(function(){
                $('.contBottom .bottomBox .box2 .box21 .caption').stop().css({'opacity':'0'})
            }).mouseout(function(){
                 $('.contBottom .bottomBox .box2 .box21 .caption').stop().css({'opacity':'1'})
            })
